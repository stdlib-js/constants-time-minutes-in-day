...
```javascript
MINUTES_IN_DAY = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-minutes-in-day@v0.3.2-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/constants-time-minutes-in-day/actions/workflows/test.yml/badge.svg?branch=v0.3.2
[test-url]: https://github.com/stdlib-js/constants-time-minutes-in-day/actions/workflows/test.yml?query=branch:v0.3.2
